...
namespace Camerawork
{
    public class AimController : BaseCamerawork
    {
        ...
        override protected void Start()
        {
            ...
            this.FixedUpdateAsObservable().Select(_ => InputEventProvider.R_Stick.Value).Subscribe(x => AimRotate(x));
            this.FixedUpdateAsObservable().Subscribe(_ => AimMove());
            if (subAimObj != null) this.UpdateAsObservable().Subscribe(_ => SubAimMove());
        }
